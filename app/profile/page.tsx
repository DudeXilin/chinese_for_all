  ...
  return (
    <main className="relative h-screen overflow-hidden text-[#292824] dark:text-[#eeeae2]">
      ...
      <div className="relative h-full overflow-y-auto overscroll-contain">
        {/* ================================================== */}
        {/* ФОН                                                 */}
        {/* Это прямой ребёнок Liquid Glass root               */}
        {/* ================================================== */}
        ...
        {/* LIQUID GLASS PANEL                                  */}
        {/*                                                    */}
        {/* ВАЖНО: это прямой ребёнок ROOT.                    */}
        {/* Никакого дополнительного wrapper между ними.       */}
        {/* ================================================== */}

        <LiquidGlassPanel
          config={glassConfig}
          className="relative z-10 mx-auto mb-20 w-[calc(100%-2.5rem)] max-w-3xl rounded-[2rem] sm:w-[calc(100%-4rem)]"
        >
