...
{/* Фоновые пятна.
Они находятся внутри root и поэтому видны Liquid Glass. */} <div className="pointer-events-none absolute left-[-12%] top-[8%] h-[420px] w-[420px] rounded-full bg-[#d6aaa0]/45 blur-[100px]" />
...
```
  ...
  {/* =========================================================
      ...
      ВАЖНО:
      Этот элемент является прямым ребёнком <main>.
      Именно этого требует библиотека.
      ========================================================= */}
